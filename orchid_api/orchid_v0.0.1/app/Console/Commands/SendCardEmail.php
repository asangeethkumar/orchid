...
class SendCardEmail extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'email:sendCard';
     ...
     * @var string
     */
    protected $description = 'Send card created at events to the recipient';
    ...
    public function handle()
    {
           /* $emailData = array(
            ...
            $test_email = 'leokonwar@gmail.com';
            
            Mail::send('emailCard', $emailData, function($message) use ($test_email) {
                    $message->to($test_email, 'Event Invitation')->subject
                       ('Card from Orchid');
        ...
        foreach($card_mapping as $data){
            ...
            $event = DB::table('events')
                    ->leftJoin('users','users.user_id','=','events.event_created_by')
            ...
            $messages = DB::table('cards_messages')
            ...
            $user_messages = $messages->toArray();
